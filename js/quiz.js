...
function answer(chosenIndex) {
  ...
  // clip's own audio carry the moment instead of layering the usual
  // correct-answer chime underneath it.
  const suppressCorrectSound = isCorrect && willTriggerImmediateMilestone();

  showAnswer(chosenIndex, question.ans, { fresh: true, suppressCorrectSound });
...
function showAnswer(chosen, correct, { fresh = false, suppressCorrectSound = false } = {}) {
